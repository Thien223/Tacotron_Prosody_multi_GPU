...
class Synthesizer:
    def load(self, checkpoint_path, hparams, GTA=False, model_name='Tacotron'):
        ...
        log('debug: Utils.TacotronSynthesizer.py line 28 - mel_outputs.shaspe: {}'.format(self.mel_outputs.shape))
        self.gta = GTA
    ...
    def synthesize(self, text, index, out_dir, log_dir, mel_filename):
        ...
        if self.gta or not hparams.predict_linear:
            ...
            log('debug: Utils.TacotronSynthesizer.py line 28 - mels.shaspe: {}'.format(mels.shape))
        else:
